...
public class PersonServiceImplServiceLocator extends org.apache.axis.client.Service implements com.demo.soap.persondemo.PersonServiceImplService {
    ...
    private java.lang.String PersonServiceImpl_address = "http://localhost:8080/SoapDemoImpl/services/PersonServiceImpl";
    ...
    public com.demo.soap.persondemo.PersonServiceImpl getPersonServiceImpl() throws javax.xml.rpc.ServiceException {
    ...
    public com.demo.soap.persondemo.PersonServiceImpl getPersonServiceImpl(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.demo.soap.persondemo.PersonServiceImplSoapBindingStub _stub = new com.demo.soap.persondemo.PersonServiceImplSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.demo.soap.persondemo.PersonServiceImpl.class.isAssignableFrom(serviceEndpointInterface)) {
                com.demo.soap.persondemo.PersonServiceImplSoapBindingStub _stub = new com.demo.soap.persondemo.PersonServiceImplSoapBindingStub(new java.net.URL(PersonServiceImpl_address), this);
                _stub.setPortName(getPersonServiceImplWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://persondemo.soap.demo.com", "PersonServiceImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://persondemo.soap.demo.com", "PersonServiceImpl"));
        }
